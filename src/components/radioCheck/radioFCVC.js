...
export default function RadioFCVC({value,onChange}) {
  ...
  return (
    <FormControl style={{ padding: '20px', margin: 'auto', maxWidth: '500px' }}>
      <FormLabel id="demo-controlled-radio-buttons-group" style={{ marginBottom: '10px' }}>Do you usually eat vegetables in your meals?</FormLabel>
      <RadioGroup
