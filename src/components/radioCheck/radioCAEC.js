...
export default function RadioCAEC({ value, onChange }) {
  ...
  return (
    <FormControl style={{ padding: '20px', margin: 'auto', maxWidth: '500px' }}>
      <FormLabel id="demo-controlled-radio-buttons-group" style={{ marginBottom: '10px' }}>Are you consuming food between meals?</FormLabel>
      <RadioGroup
      ...
      >
        ...
        <FormControlLabel value="Always" control={<Radio />} label="Always" style={{ marginRight: '20px' }} />
